...
The installer preserves the previous hooks path and existing `pre-commit` hook, then runs agnix against the staged index before each commit. Git does not install tracked hooks automatically when you clone.
