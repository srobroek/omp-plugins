...
- A push to `main` here trips `rule://delivery-main-branch-push-advisory`. That warning never blocks the push and needs no authorization; confirm the destination repository is the intended one and continue.
