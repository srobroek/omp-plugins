...
## [1.0.1](https://github.com/srobroek/omp-plugins/compare/session--v1.0.0...session--v1.0.1) (2026-08-25)
...
## [1.0.0](https://github.com/srobroek/omp-plugins/compare/session--v0.1.0...session--v1.0.0) (2026-08-25)
...
* **session:** document the OMP transcript format and branch tiers ([836ace9](https://github.com/srobroek/omp-plugins/commit/836ace919e867f7ec3f560096183cb83ab4a0251))
