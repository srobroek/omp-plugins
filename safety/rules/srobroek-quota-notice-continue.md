...
description: A bare "You have N weighted tokens left" or "You have N tokens left" line is a provider quota notice, not a result; keep working.
...
The line you just produced, `You have N weighted tokens left` (or `You have N tokens left`), is not part of the task.
