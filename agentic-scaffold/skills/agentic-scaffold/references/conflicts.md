...
| Foreign hooks (`husky`, `lefthook`, `core.hooksPath`) | preflight `hook-manager` finding | Choose repository hooks, git-defender chaining, migration, or skip hooks in the interview. |
