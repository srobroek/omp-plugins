...
model: "@task"
thinking-level: high
tools: read, github, delivery_orient, delivery_land, bd_reconcile, delivery_cleanup
---
...
## Task
1. Invoke `delivery_orient` before any role-restricted action, then establish the target repository, PR, base branch, head branch, and reviewed head from read-only forge evidence.
