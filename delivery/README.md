...
| `delivery_cleanup` | `exec` | Remove and verify one already-reconciled landed worktree and branch. |
...
| `integrator` | Merge-queue actor. It verifies landing proof before it closes a merge-linked bead. |
