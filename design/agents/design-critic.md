---
name: design-critic
description: Critiques a rendered surface for hierarchy, rhythm, and generated-UI tells, returning a verdict. Spawn at CRITIQUE beside a11y-auditor; read-only, never implements or edits.
model: "@designer"
thinking-level: high
