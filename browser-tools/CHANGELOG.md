...
## [0.3.3](https://github.com/srobroek/omp-plugins/compare/browser-tools--v0.3.2...browser-tools--v0.3.3) (2026-09-11)


### Documentation

* **browser-tools:** clear the prose findings in the lines I authored ([27e6706](https://github.com/srobroek/omp-plugins/commit/27e6706f818a247fbe3db5bc103e4ef5e0c9b4de))
* **browser-tools:** clear the prose findings in the lines I authored ([be37a2d](https://github.com/srobroek/omp-plugins/commit/be37a2da4a9a429fe3b6bd0460018f3f7a535b57))
* **browser-tools:** rescope one claim and cut a sentence that earned nothing ([116453c](https://github.com/srobroek/omp-plugins/commit/116453c6923307388f263634b4700a7841a4bbf4))
* **browser-tools:** rescope one claim and cut a sentence that earned nothing ([47da008](https://github.com/srobroek/omp-plugins/commit/47da0082fd702b80a0bb1b85d9e2e570f5ce9d4c))
* **browser-tools:** say that the cross-engine server runs @playwright/mcp ([d18e343](https://github.com/srobroek/omp-plugins/commit/d18e343c1dbcac1e12dacced6b46131f46ec09f6))
* **browser-tools:** say that the cross-engine server runs @playwright/mcp ([0d840b8](https://github.com/srobroek/omp-plugins/commit/0d840b837575a6760cf8b61a57688ac6908e0367))
...
## [0.2.0](https://github.com/srobroek/omp-plugins/compare/browser-tools--v0.1.0...browser-tools--v0.2.0) (2026-08-27)
...
* **design:** add the design plugin, plus browser-tools and diagram ([16ba8e1](https://github.com/srobroek/omp-plugins/commit/16ba8e188f2ae4148eac8d93aeb6dede7bd025c5))


### Bug Fixes

* **design:** correct commands that fail as documented, add design-overview ([edd6284](https://github.com/srobroek/omp-plugins/commit/edd6284415b9fa8ba665880aa1160a3f6c7ceeb1))


### Documentation

* correct the carrier table and add install sections ([e5fa7e8](https://github.com/srobroek/omp-plugins/commit/e5fa7e8f16df5bc8112876cff3826910832cfde2))
